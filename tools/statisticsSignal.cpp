...
static const auto naiveMinSingleFilePath = std::string(ROOT_DIR) + "/output/SignalNaiveMinSingle.txt";
static const auto naiveMinMultiFilePath = std::string(ROOT_DIR) + "/output/SignalNaiveMinMulti.txt";
static const auto naiveMaxSingleFilePath = std::string(ROOT_DIR) + "/output/SignalNaiveMaxSingle.txt";
static const auto naiveMaxMultiFilePath = std::string(ROOT_DIR) + "/output/SignalNaiveMaxMulti.txt";

static const auto smartMinSingleFilePath = std::string(ROOT_DIR) + "/outputSignal/SmartMinSingle.txt";
static const auto smartMinMultiFilePath = std::string(ROOT_DIR) + "/output/SignalSmartMinMulti.txt";
static const auto smartMaxSingleFilePath = std::string(ROOT_DIR) + "/output/SignalSmartMaxSingle.txt";
static const auto smartMaxMultiFilePath = std::string(ROOT_DIR) + "/output/SignalSmartMaxMulti.txt";
...
static const auto statisticsOutputFilePath = std::string(ROOT_DIR) + "/output/SignalStatistics.txt";
