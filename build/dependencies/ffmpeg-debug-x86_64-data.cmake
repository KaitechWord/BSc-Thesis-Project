...
if(DEFINED ffmpeg_FIND_DEPENDENCY_NAMES)
  list(APPEND ffmpeg_FIND_DEPENDENCY_NAMES LibLZMA freetype BZip2 OpenJPEG openh264 libx264 libx265 libvpx fdk-aac WebP pulseaudio Iconv Vorbis Opus libmp3lame ALSA xorg OpenSSL ZLIB vaapi vdpau libaom-av1 dav1d)
  list(REMOVE_DUPLICATES ffmpeg_FIND_DEPENDENCY_NAMES)
else()
  set(ffmpeg_FIND_DEPENDENCY_NAMES LibLZMA freetype BZip2 OpenJPEG openh264 libx264 libx265 libvpx fdk-aac WebP pulseaudio Iconv Vorbis Opus libmp3lame ALSA xorg OpenSSL ZLIB vaapi vdpau libaom-av1 dav1d)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(ffmpeg_PACKAGE_FOLDER_DEBUG "/home/kajtekk/.conan2/p/b/ffmpeb5774809463b9/p")
...
set(ffmpeg_SHARED_LINK_FLAGS_DEBUG "-Wl,-Bsymbolic")
set(ffmpeg_EXE_LINK_FLAGS_DEBUG "-Wl,-Bsymbolic")
...
set(ffmpeg_ffmpeg_avdevice_IS_HOST_WINDOWS_DEBUG 0)
...
set(ffmpeg_ffmpeg_avdevice_SYSTEM_LIBS_DEBUG m)
set(ffmpeg_ffmpeg_avdevice_FRAMEWORK_DIRS_DEBUG )
set(ffmpeg_ffmpeg_avdevice_FRAMEWORKS_DEBUG )
set(ffmpeg_ffmpeg_avdevice_DEPENDENCIES_DEBUG ffmpeg::avutil ffmpeg::avfilter ffmpeg::swscale ffmpeg::avformat ffmpeg::avcodec ffmpeg::swresample ffmpeg::postproc ALSA::ALSA xorg::xcb pulseaudio::pulseaudio)
...
set(ffmpeg_ffmpeg_avfilter_IS_HOST_WINDOWS_DEBUG 0)
...
set(ffmpeg_ffmpeg_avfilter_SYSTEM_LIBS_DEBUG m pthread)
...
set(ffmpeg_ffmpeg_avcodec_SHARED_LINK_FLAGS_DEBUG "-Wl,-Bsymbolic")
set(ffmpeg_ffmpeg_avcodec_EXE_LINK_FLAGS_DEBUG "-Wl,-Bsymbolic")
...
set(ffmpeg_ffmpeg_postproc_IS_HOST_WINDOWS_DEBUG 0)
...
set(ffmpeg_ffmpeg_postproc_SYSTEM_LIBS_DEBUG m)
...
set(ffmpeg_ffmpeg_avutil_DEPENDENCIES_DEBUG vaapi::vaapi xorg::x11 vdpau::vdpau)
