...
set_property(TARGET ffmpeg_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:ffmpeg::avutil;ffmpeg::avfilter;ffmpeg::swscale;ffmpeg::avformat;ffmpeg::avcodec;ffmpeg::swresample;ffmpeg::postproc;ALSA::ALSA;xorg::xcb;pulseaudio::pulseaudio;Freetype::Freetype;BZip2::BZip2;OpenSSL::SSL;ZLIB::ZLIB;LibLZMA::LibLZMA;Iconv::Iconv;openjp2;openh264::openh264;vorbis::vorbis;Opus::opus;libx264::libx264;libx265::libx265;libvpx::libvpx;libmp3lame::libmp3lame;FDK-AAC::fdk-aac;libwebp::libwebp;libaom-av1::libaom-av1;dav1d::dav1d;vaapi::vaapi;xorg::x11;vdpau::vdpau>)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT ffmpeg::avdevice #############
        ...
        set(ffmpeg_ffmpeg_avdevice_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(ffmpeg_ffmpeg_avdevice_FRAMEWORKS_FOUND_RELEASE "${ffmpeg_ffmpeg_avdevice_FRAMEWORKS_RELEASE}" "${ffmpeg_ffmpeg_avdevice_FRAMEWORK_DIRS_RELEASE}")

        set(ffmpeg_ffmpeg_avdevice_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET ffmpeg_ffmpeg_avdevice_DEPS_TARGET)
            add_library(ffmpeg_ffmpeg_avdevice_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET ffmpeg_ffmpeg_avdevice_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'ffmpeg_ffmpeg_avdevice_DEPS_TARGET' to all of them
        conan_package_library_targets("${ffmpeg_ffmpeg_avdevice_LIBS_RELEASE}"
                              "${ffmpeg_ffmpeg_avdevice_LIB_DIRS_RELEASE}"
                              "${ffmpeg_ffmpeg_avdevice_BIN_DIRS_RELEASE}" # package_bindir
                              "${ffmpeg_ffmpeg_avdevice_LIBRARY_TYPE_RELEASE}"
                              "${ffmpeg_ffmpeg_avdevice_IS_HOST_WINDOWS_RELEASE}"
                              ffmpeg_ffmpeg_avdevice_DEPS_TARGET
                              ffmpeg_ffmpeg_avdevice_LIBRARIES_TARGETS
                              "_RELEASE"
                              "ffmpeg_ffmpeg_avdevice"
                              "${ffmpeg_ffmpeg_avdevice_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET ffmpeg::avdevice
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_LIBRARIES_TARGETS}>
                     )

        if("${ffmpeg_ffmpeg_avdevice_LIBS_RELEASE}" STREQUAL "")
        ...
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_LIB_DIRS_RELEASE}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avdevice_COMPILE_OPTIONS_RELEASE}>)

    ########## COMPONENT ffmpeg::avfilter #############

        set(ffmpeg_ffmpeg_avfilter_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(ffmpeg_ffmpeg_avfilter_FRAMEWORKS_FOUND_RELEASE "${ffmpeg_ffmpeg_avfilter_FRAMEWORKS_RELEASE}" "${ffmpeg_ffmpeg_avfilter_FRAMEWORK_DIRS_RELEASE}")

        set(ffmpeg_ffmpeg_avfilter_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET ffmpeg_ffmpeg_avfilter_DEPS_TARGET)
            add_library(ffmpeg_ffmpeg_avfilter_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET ffmpeg_ffmpeg_avfilter_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'ffmpeg_ffmpeg_avfilter_DEPS_TARGET' to all of them
        conan_package_library_targets("${ffmpeg_ffmpeg_avfilter_LIBS_RELEASE}"
                              "${ffmpeg_ffmpeg_avfilter_LIB_DIRS_RELEASE}"
                              "${ffmpeg_ffmpeg_avfilter_BIN_DIRS_RELEASE}" # package_bindir
                              "${ffmpeg_ffmpeg_avfilter_LIBRARY_TYPE_RELEASE}"
                              "${ffmpeg_ffmpeg_avfilter_IS_HOST_WINDOWS_RELEASE}"
                              ffmpeg_ffmpeg_avfilter_DEPS_TARGET
                              ffmpeg_ffmpeg_avfilter_LIBRARIES_TARGETS
                              "_RELEASE"
                              "ffmpeg_ffmpeg_avfilter"
                              "${ffmpeg_ffmpeg_avfilter_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET ffmpeg::avfilter
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_LIBRARIES_TARGETS}>
                     )

        if("${ffmpeg_ffmpeg_avfilter_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET ffmpeg::avfilter
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET ffmpeg::avfilter APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET ffmpeg::avfilter APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET ffmpeg::avfilter APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_LIB_DIRS_RELEASE}>)
        set_property(TARGET ffmpeg::avfilter APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET ffmpeg::avfilter APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_avfilter_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT ffmpeg::postproc #############

        set(ffmpeg_ffmpeg_postproc_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(ffmpeg_ffmpeg_postproc_FRAMEWORKS_FOUND_RELEASE "${ffmpeg_ffmpeg_postproc_FRAMEWORKS_RELEASE}" "${ffmpeg_ffmpeg_postproc_FRAMEWORK_DIRS_RELEASE}")

        set(ffmpeg_ffmpeg_postproc_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET ffmpeg_ffmpeg_postproc_DEPS_TARGET)
            add_library(ffmpeg_ffmpeg_postproc_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET ffmpeg_ffmpeg_postproc_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'ffmpeg_ffmpeg_postproc_DEPS_TARGET' to all of them
        conan_package_library_targets("${ffmpeg_ffmpeg_postproc_LIBS_RELEASE}"
                              "${ffmpeg_ffmpeg_postproc_LIB_DIRS_RELEASE}"
                              "${ffmpeg_ffmpeg_postproc_BIN_DIRS_RELEASE}" # package_bindir
                              "${ffmpeg_ffmpeg_postproc_LIBRARY_TYPE_RELEASE}"
                              "${ffmpeg_ffmpeg_postproc_IS_HOST_WINDOWS_RELEASE}"
                              ffmpeg_ffmpeg_postproc_DEPS_TARGET
                              ffmpeg_ffmpeg_postproc_LIBRARIES_TARGETS
                              "_RELEASE"
                              "ffmpeg_ffmpeg_postproc"
                              "${ffmpeg_ffmpeg_postproc_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET ffmpeg::postproc
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_LIBRARIES_TARGETS}>
                     )

        if("${ffmpeg_ffmpeg_postproc_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET ffmpeg::postproc
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET ffmpeg::postproc APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET ffmpeg::postproc APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET ffmpeg::postproc APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_LIB_DIRS_RELEASE}>)
        set_property(TARGET ffmpeg::postproc APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET ffmpeg::postproc APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${ffmpeg_ffmpeg_postproc_COMPILE_OPTIONS_RELEASE}>)
    ...
    set_property(TARGET ffmpeg::ffmpeg APPEND PROPERTY INTERFACE_LINK_LIBRARIES ffmpeg::avdevice)
    set_property(TARGET ffmpeg::ffmpeg APPEND PROPERTY INTERFACE_LINK_LIBRARIES ffmpeg::avfilter)
    ...
    set_property(TARGET ffmpeg::ffmpeg APPEND PROPERTY INTERFACE_LINK_LIBRARIES ffmpeg::postproc)
