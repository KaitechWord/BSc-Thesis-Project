...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT ffmpeg::avdevice #############
        ...
        set(ffmpeg_ffmpeg_avdevice_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(ffmpeg_ffmpeg_avdevice_FRAMEWORKS_FOUND_DEBUG "${ffmpeg_ffmpeg_avdevice_FRAMEWORKS_DEBUG}" "${ffmpeg_ffmpeg_avdevice_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET ffmpeg_ffmpeg_avdevice_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_DEPENDENCIES_DEBUG}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'ffmpeg_ffmpeg_avdevice_DEPS_TARGET' to all of them
        conan_package_library_targets("${ffmpeg_ffmpeg_avdevice_LIBS_DEBUG}"
                              "${ffmpeg_ffmpeg_avdevice_LIB_DIRS_DEBUG}"
                              "${ffmpeg_ffmpeg_avdevice_BIN_DIRS_DEBUG}" # package_bindir
                              "${ffmpeg_ffmpeg_avdevice_LIBRARY_TYPE_DEBUG}"
                              "${ffmpeg_ffmpeg_avdevice_IS_HOST_WINDOWS_DEBUG}"
                              ffmpeg_ffmpeg_avdevice_DEPS_TARGET
                              ffmpeg_ffmpeg_avdevice_LIBRARIES_TARGETS
                              "_DEBUG"
                              "ffmpeg_ffmpeg_avdevice"
                              "${ffmpeg_ffmpeg_avdevice_NO_SONAME_MODE_DEBUG}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET ffmpeg::avdevice
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_LIBRARIES_TARGETS}>
                     )

        if("${ffmpeg_ffmpeg_avdevice_LIBS_DEBUG}" STREQUAL "")
        ...
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_LINKER_FLAGS_DEBUG}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_INCLUDE_DIRS_DEBUG}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_LIB_DIRS_DEBUG}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_COMPILE_DEFINITIONS_DEBUG}>)
        set_property(TARGET ffmpeg::avdevice APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avdevice_COMPILE_OPTIONS_DEBUG}>)

    ########## COMPONENT ffmpeg::avfilter #############

        set(ffmpeg_ffmpeg_avfilter_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(ffmpeg_ffmpeg_avfilter_FRAMEWORKS_FOUND_DEBUG "${ffmpeg_ffmpeg_avfilter_FRAMEWORKS_DEBUG}" "${ffmpeg_ffmpeg_avfilter_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET ffmpeg_ffmpeg_avfilter_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avfilter_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avfilter_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avfilter_DEPENDENCIES_DEBUG}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'ffmpeg_ffmpeg_avfilter_DEPS_TARGET' to all of them
        conan_package_library_targets("${ffmpeg_ffmpeg_avfilter_LIBS_DEBUG}"
                              "${ffmpeg_ffmpeg_avfilter_LIB_DIRS_DEBUG}"
                              "${ffmpeg_ffmpeg_avfilter_BIN_DIRS_DEBUG}" # package_bindir
                              "${ffmpeg_ffmpeg_avfilter_LIBRARY_TYPE_DEBUG}"
                              "${ffmpeg_ffmpeg_avfilter_IS_HOST_WINDOWS_DEBUG}"
                              ffmpeg_ffmpeg_avfilter_DEPS_TARGET
                              ffmpeg_ffmpeg_avfilter_LIBRARIES_TARGETS
                              "_DEBUG"
                              "ffmpeg_ffmpeg_avfilter"
                              "${ffmpeg_ffmpeg_avfilter_NO_SONAME_MODE_DEBUG}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET ffmpeg::avfilter
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avfilter_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_avfilter_LIBRARIES_TARGETS}>
                     )

        if("${ffmpeg_ffmpeg_avfilter_LIBS_DEBUG}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET ffmpeg::avfilter
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
    ...
    ########## COMPONENT ffmpeg::postproc #############
        ...
        set(ffmpeg_ffmpeg_postproc_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(ffmpeg_ffmpeg_postproc_FRAMEWORKS_FOUND_DEBUG "${ffmpeg_ffmpeg_postproc_FRAMEWORKS_DEBUG}" "${ffmpeg_ffmpeg_postproc_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET ffmpeg_ffmpeg_postproc_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_postproc_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_postproc_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_postproc_DEPENDENCIES_DEBUG}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'ffmpeg_ffmpeg_postproc_DEPS_TARGET' to all of them
        conan_package_library_targets("${ffmpeg_ffmpeg_postproc_LIBS_DEBUG}"
                              "${ffmpeg_ffmpeg_postproc_LIB_DIRS_DEBUG}"
                              "${ffmpeg_ffmpeg_postproc_BIN_DIRS_DEBUG}" # package_bindir
                              "${ffmpeg_ffmpeg_postproc_LIBRARY_TYPE_DEBUG}"
                              "${ffmpeg_ffmpeg_postproc_IS_HOST_WINDOWS_DEBUG}"
                              ffmpeg_ffmpeg_postproc_DEPS_TARGET
                              ffmpeg_ffmpeg_postproc_LIBRARIES_TARGETS
                              "_DEBUG"
                              "ffmpeg_ffmpeg_postproc"
                              "${ffmpeg_ffmpeg_postproc_NO_SONAME_MODE_DEBUG}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET ffmpeg::postproc
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_postproc_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${ffmpeg_ffmpeg_postproc_LIBRARIES_TARGETS}>
                     )

        if("${ffmpeg_ffmpeg_postproc_LIBS_DEBUG}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET ffmpeg::postproc
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
